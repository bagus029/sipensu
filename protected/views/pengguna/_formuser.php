<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<!--<div class="form-group">
		...
		<div class="col-md-2">
		<?php //echo $form->textField($model,'IDPENGGUNA',array('size'=>1,'maxlength'=>1,'class'=>'form-control')); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-3">
		<?php echo $form->textField($model,'USERNAME',array('size'=>60,'maxlength'=>100,'class'=>'form-control','disabled'=>true)); ?>
	...
	<div class="form-actions fluid">
		...
		<?php echo CHtml::submitButton($model->isNewRecord ? 'Simpan' : 'Save',array('class'=>'btn green')); ?>

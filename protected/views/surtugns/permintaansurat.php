    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Daftar Permintaan Surat Tugas Lainnya
            </div>
            <div class="card-body">
                <?php echo CHtml::link('<i class="fa fa-plus"></i> Tambah', array('createdosen'), array('class' => 'btn btn-primary waves-effect waves-float waves-light')); ?>
            </div>
        </div>
                   ...
                   // 'itemsCssClass' => 'table table-bordered table-striped table-hover',
                    'columns' => array(
                        ...
                        array(
                            'header' => 'Detail Surat',
                            'type' => 'raw',
                            'value' => 'CHtml::link("Lihat ",array("surtugns/isisurat","id"=>$data->primaryKey),array ("class"=>"btn btn-sm purple "))',
                        ),
                        array(
                            'name' => 'Accsurat',
                            'filter' => '',

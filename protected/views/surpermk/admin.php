...
<?php $this->widget('ext.EExcelView', array(
	...
	'columns'=>array(
        ...
        array(
            ...
            'filter'=>'' ,
            'header'=>'Subkor',
            'value'=>'CHtml::label($data->getAccsubkor(),"",array("onClick"=>"tes1(\'$data->IDMK\',$row,\'$data->IDMK\')","id"=>"label_$row","class"=>"btn btn-sm red"));'
         ),
        array(
            'name'=>'ACCDEKANAT',
            'type'=>'raw',
            'filter'=>'' ,
            'header'=>'Dekanat',
            'value'=>'CHtml::label($data->getAccdekanat(),"",array("onClick"=>"tes2(\'$data->IDMK\',$row,\'$data->IDMK\')","id"=>"label_$row","class"=>"btn btn-sm green"));'
        ),
        array(
            'name'=>'ACCSURPERMK',
            'filter'=>'' ,
            'type'=>'raw',
            'header'=>'Status Surat',
            'value'=>'CHtml::label($data->getAccsurat(),"",array("onClick"=>"tes(\'$data->IDMK\',$row,\'$data->IDMK\')","id"=>"label_$row","class"=>"btn btn-sm blue"));'
        ),
	),
)); ?>
</div>
...
<?php
echo CHtml::label('Beri Acc Surat', 'ACCSURPERMK').'&nbsp;:&nbsp;';
echo CHtml::dropDownList('ACCSURPERMK','',array('Approve'=>'Yes', 'Not Approved'=>'No')); 

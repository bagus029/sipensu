                    ...
                    <?php $this->widget('zii.widgets.grid.CGridView', array(
                        ...
                        'columns'=>array(
                            ...
                            array(
                                ...
                                'type'=>'raw',
                                'header'=>'Status Surat',
                                'value'=>'CHtml::label($data->ACCSURAKTIFCUTI,"",array("onClick"=>"tes(\'$data->IDAKTIFCUTI\',$row,\'$data->IDAKTIFCUTI\')","id"=>"label_$row","class"=>"btn btn-sm blue"));'
                                //'value'=>'CHtml::label($data->ACCSURAKTIFCUTI=="Approve"?$data->ACCSURAKTIFCUTI:"Pending","",array("onClick"=>"tes(\'$data->IDAKTIFCUTI\',$row,\'$data->IDAKTIFCUTI\')","id"=>"label_$row","class"=>"btn btn-sm blue"));'
                            ),
                            array(
                                'name'=>'ACCSUBKOR',
                                'type'=>'raw',

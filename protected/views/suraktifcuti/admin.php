            ...
            <?php $this->widget('zii.widgets.grid.CGridView', array(
                ...
                'columns' => array(
                    ...
                    array(
                        ...
                        'type' => 'raw',
                        'value' => 'CHtml::link("Cetak ",array("cetak/surpermohonanaktifcuti","id"=>$data->primaryKey),array ("target"=>"_blank","class"=>"btn btn-gradient-warning"))',
                    ),
                    array(
                        'header' => 'Cetak Surat',
                        'type' => 'raw',
                    ...
                    //    'filter' => '',
                        ...
                        'value' => 'CHtml::label($data->getAccsubkor(),"",array("onClick"=>"tes1(\'$data->IDAKTIFCUTI\',$row,\'$data->IDAKTIFCUTI\')","id"=>"label_$row","class"=>"btn btn-sm red"));'
                    ),
                    array(
                        'name' => 'ACCDEKANAT',
                        'type' => 'raw',
                    //    'filter' => '',
                        'header' => 'Acc Dekanat',
                        'value' => 'CHtml::label($data->getAccdekanat(),"",array("onClick"=>"tes2(\'$data->IDAKTIFCUTI\',$row,\'$data->IDAKTIFCUTI\')","id"=>"label_$row","class"=>"btn btn-sm green"));'
                    ),
                ),
            )); ?>
        </div>
        <?php echo CHtml::link('<i class="fa fa-caret-left"></i> &nbsp;List Izin Cuti Akademik&nbsp', array('surijincuti/admin'), array('class' => 'btn btn-gradient-primary'));
        ?>
    </div>
</div>
<?php

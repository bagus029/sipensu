...
<div class="form-actions  left">
     <div class="">
		 ...
		 <?php echo CHtml::link('Lihat Permintaan Surat Aktif Kembali Cuti <i class="fa fa-search"></i>' ,array('suraktifcuti/permintaansurat'),array('class'=>'btn btn-outline-warning waves-effect'));?> 
                <?php 
                    $a=$model->IDAKTIFCUTI;
                    ...
                    if($b==0){    
                    echo CHtml::link('Edit  <i class="fa fa-edit"></i>',array('suraktifcuti/updatebymahasiswa','id'=>$model->IDAKTIFCUTI),array('class'=>'btn btn-outline-primary waves-effect'));
                    }
                    else
                    {
                       echo "";
...
<div class="caption">
	<i class="fa fa-envelope"></i> Kirim Permintaan Surat Aktif Kembali Cuti  #<?php echo $model->IDAKTIFCUTI; ?>  </div>
        ...
        if($b==0){    
        echo CHtml::link('Ajukan permintaan/permohonan surat.... <i class="fa fa-arrow-circle-right"></i>',array('detailaktifcuti/createbymahasiswa','IDAKTIFCUTI'=>$model->IDAKTIFCUTI),array('class'=>'btn btn-outline-danger waves-effect'));
         }
        else
        {

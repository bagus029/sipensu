                ...
                <?php if (!Yii::app()->user->isGuest && Yii::app()->user->IDGROUPS == '9'): ?>
                    <li class="dropdown nav-item" data-menu="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li data-menu="">
                                <a class="dropdown-item d-flex align-items-center" href="<?php echo Yii::app()->createUrl('suratketerangan/permintaansuratketerangan'); ?>" data-toggle="dropdown" data-i18n="Email">

<div class="portlet box yellow">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-cogs"></i> Manage Surat Permohonan Praktik Kerja (Prodi D3)
        </div>
        <div class="actions">
            ...
            <?php $this->widget('zii.widgets.grid.CGridView', array(
                ...
                'columns' => array(
                    ...
                    array(
                        ...
                        'filter' => '',
                        'header' => 'Acc Dekanat',
                        'value' => 'CHtml::label($data->ACCDEKANAT,"",array("onClick"=>"tes2(\'$data->IDPK\',$row,\'$data->IDPK\')","id"=>"label_$row","class"=>"btn btn-sm green"));'
                    ),

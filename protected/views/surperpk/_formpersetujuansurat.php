	...
	<div class="form-group">
		...
		<?php echo $form->error($model,'KOTAINSTANSIPK'); ?>
            ...
            <div class="form-check form-check-inline">
                ...
                <?php echo $form->labelEx($model,'Set Persetujuan Surat/Generate Pelaksanaan Praktik Kerja',array('class'=>'form-check-label'));?>

                <?php echo $form->radioButtonList($model,'ACCPERPK',array('Approve'=>'Approve','Not Approved'=>'Not Approved'),array('class'=>'form-check-label', 'for'=>'inlineRadio1'));
                ?>

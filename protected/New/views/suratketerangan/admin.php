    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Manage Permintaan Surat Keterangan</h4>
            </div>
            <div class="card-body">
	...
	'columns'=>array(
                ...
                array(
	             ...
	             array(
                    ...
                    'filter'=>'' ,
                    'header'=>'Status Surat',
                    'value'=>'CHtml::label($data->getAccsurat(),"",array("onClick"=>"tes(\'$data->IDSURKET\',$row,\'$data->IDSURKET\')","id"=>"label_$row","class"=>"btn btn-sm blue"));'
        ...
        array(
            ...
            'value'=>'CHtml::label($data->getAccsubkor(),"",array("onClick"=>"tes1(\'$data->IDSURKET\',$row,\'$data->IDSURKET\')","id"=>"label_$row","class"=>"btn btn-sm red"));'
        ),
        array(
            'name'=>'ACCDEKANAT',
            'type'=>'raw',
            'filter'=>'' ,
            'header'=>'Acc Dekanat',
            'value'=>'CHtml::label($data->getAccdekanat(),"",array("onClick"=>"tes2(\'$data->IDSURKET\',$row,\'$data->IDSURKET\')","id"=>"label_$row","class"=>"btn btn-sm green"));'
        ),
	),
)); ?>
</div>
...
<?php
echo CHtml::label('Beri Acc Surat', 'ACCSURKET').'&nbsp;:&nbsp;';
echo CHtml::dropDownList('ACCSURKET','',array('Approve'=>'Yes', 'Not Approved'=>'No')); 

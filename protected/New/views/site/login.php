...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->getBaseUrl() ?>/vuexy/app-assets/css/plugins/forms/form-validation.css">
    <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->getBaseUrl() ?>/vuexy/app-assets/css/pages/page-auth.css">
    <!-- END: Page CSS-->
...
<!-- BEGIN: Vendor JS-->
<script src="<?php echo Yii::app()->getBaseUrl() ?>/vuexy/app-assets/vendors/js/vendors.min.js"></script>
<!-- BEGIN Vendor JS-->

<!-- BEGIN: Page Vendor JS-->
<script src="<?php echo Yii::app()->getBaseUrl() ?>/vuexy/app-assets/vendors/js/ui/jquery.sticky.js"></script>
<script src="<?php echo Yii::app()->getBaseUrl() ?>/vuexy/app-assets/vendors/js/forms/validation/jquery.validate.min.js"></script>
<!-- END: Page Vendor JS-->
...
<!-- BEGIN: Page JS-->
<script src="<?php echo Yii::app()->getBaseUrl() ?>/vuexy/app-assets/js/scripts/pages/page-auth-login.js"></script>
<!-- END: Page JS-->

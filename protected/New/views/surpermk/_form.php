<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		...
		<?php echo $form->labelEx($model,'KETERANGANSURPERMK',array('class'=>'col-md-3 control-label')); ?>
                 <div class="col-md-6">
                    <div class="input-icon right">
                        <i class="fa fa-check tooltips" data-container="body" data-original-titlr="You look OK!"></i>
                    </div>
		<?php echo $form->textArea($model,'KETERANGANSURPERMK',array('rows'=>6, 'cols'=>50,'class'=>'form-control')); ?>
		<?php echo $form->error($model,'KETERANGANSURPERMK'); ?>
                </div>
	</div>

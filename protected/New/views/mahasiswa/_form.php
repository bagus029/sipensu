...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
       ...
       <div class="form-group">
		<?php echo $form->labelEx($model,'JENIS KELAMIN',array('class'=>'col-md-3 control-label')); ?>
                ...
                CHtml::listData(Jender::model()->findAll(array('order'=>'IDJENDER')), 'IDJENDER', 'NAMAJENDER'),array('empty'=>'----Pilih Jenis Kelamin----','class'=>'form-control select2me')); ?>
	...
	<div class="form-actions fluid">
		...
		<?php //if(!$model->isNewRecord) echo CHtml::link('Manage Mahasiswa',array('mahasiswa/admin','NIM'=>$model->NIM),array('class'=>'btn yellow')) ?>
		</div>
	</div>

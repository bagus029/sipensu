...
class Jenjang extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			//array('IDJENJANG', 'required'),
			array('IDJENJANG', 'length', 'max'=>11),
			array('NAMAJENJANG', 'length', 'max'=>20),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('IDJENJANG, NAMAJENJANG', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'prodis' => array(self::HAS_MANY, 'Prodi', 'IDJENJANG'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('NAMAJENJANG',$this->NAMAJENJANG,true);

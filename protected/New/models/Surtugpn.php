...
class Surtugpn extends CActiveRecord
{
	...
	public function search()
	{
       ...
       public function getListinstansipn(){
            ...
            if ($b > 0) {
            echo CHtml::link('<i class="fa fa-print"></i> Cetak',array('cetak/groupinstansisurtugpn','id'=>$groupinstansipn->IDGROUPINSTANSIPN),array('target'=>'_blank','class'=>'btn btn-sm purple'));       
            }
             else {
        ...
        if ($b > 0) {
            echo CHtml::link('<i data-feather="printer"></i>', array('cetak/surtugpn', 'id' => $this->IDPN), array('target' => '_blank', 'class' => 'btn btn-gradient-warning'));
        } else {
            echo "<font color='red'> Tgl.cetak belum di set..</font>";
        }
        }

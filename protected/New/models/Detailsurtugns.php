	...
	public function search()
	{
        ...
        public function getListactionnotifikasi(){
            ...
            if ($b == 'Y') {
                ...
                echo CHtml::link('<i data-feather="search"></i>', array('detailsurtugns/view', 'id' => $this->IDDETAILSURTUGNS), array('class' => 'btn btn-info')),'&nbsp';
                echo CHtml::link('<i data-feather="edit"></i>', array('surtugns/updatenosurtugnsoperator','id'=>$this->IDSURTUGNS), array('class' => 'btn btn-success'));
               
            } else {
               
                if ($c == 'N') {
                   
                    echo CHtml::link('<i data-feather="search"></i>', array('detailsurtugns/view', 'id' => $this->IDDETAILSURTUGNS), array('class' => 'btn btn-warning')),'&nbsp';
                    echo CHtml::link('<i data-feather="edit"></i>', array('surtugns/updatenosurtugnsoperator','id'=>$this->IDSURTUGNS), array('class' => 'btn btn-primary'));
                } 
        }

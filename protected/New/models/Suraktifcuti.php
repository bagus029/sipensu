...
class Suraktifcuti extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('ACCSURAKTIFCUTI,PREVIEW,ACCPIMPINAN', 'length', 'max' => 15),
    ...
    public function getListactionnotifikasi()
    {
        ...
        if ($b == 'Y') {
            ...
            echo CHtml::link('<i data-feather="search"></i>', array('suraktifcuti/view', 'id' => $this->IDAKTIFCUTI), array('class' => 'btn btn-sm blue')), '&nbsp';
    ...
    public function getStatussurat()
    {
        ...
        } else if ($this->ACCSURAKTIFCUTI == 'Not Approved') {
    ...
    public function getCetakbytgl()
    {
        ...
        if ($b > 0) {
            echo CHtml::link('<i data-feather="print"></i> Cetak', array('cetak/suraktifcuti', 'id' => $this->IDAKTIFCUTI), array('target' => '_blank', 'class' => 'btn btn-sm yellow'));

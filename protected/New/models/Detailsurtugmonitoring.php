	...
	public function search()
	{
        ...
        public function getListactionnotifikasi(){
            ...
            if ($b == 'Y') {
                ...
                echo CHtml::link('<i data-feather="search"></i>', array('detailsurtugmonitoring/view', 'id' => $this->IDDETAILSURTUGMONITORING), array('class' => 'btn btn-info')),'&nbsp';
                echo CHtml::link('<i data-feather="edit"></i>', array('surtugmonitoring/updatenosurtugmonitoringoperator','id'=>$this->IDSURTUGMONITORING), array('class' => 'btn btn-success'));
               
            } else {
               
                if ($c == 'N') {
                   
                    echo CHtml::link('<i data-feather="search"></i>', array('detailsurtugmonitoring/view', 'id' => $this->IDDETAILSURTUGMONITORING), array('class' => 'btn btn-danger')),'&nbsp';
                    echo CHtml::link('<i data-feather="edit"></i>', array('surtugmonitoring/updatenosurtugmonitoringoperator','id'=>$this->IDSURTUGMONITORING), array('class' => 'btn btn-primary'));
                } 
        }

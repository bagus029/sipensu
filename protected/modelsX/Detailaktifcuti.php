	...
	public function search()
	{
        ...
        public function getListactionnotifikasi(){
            ...
            if ($b == 'Y') {
                ...
                echo CHtml::link('<i class="fa fa-search"></i>', array('detailaktifcuti/view', 'id' => $this->IDDETAILSURAKTIFCUTI), array('class' => 'btn btn-sm blue')),'&nbsp';
                echo CHtml::link('<i class="fa fa-edit"></i>', array('suraktifcuti/updatenosuraktifcutioperator','id'=>$this->IDAKTIFCUTI), array('class' => 'btn btn-sm green'));
               
            } else {
               
                if ($c == 'N') {
                   
                    echo CHtml::link('<i class="fa fa-search"></i>', array('detailaktifcuti/view', 'id' => $this->IDDETAILSURAKTIFCUTI), array('class' => 'btn btn-sm red')),'&nbsp';
                    echo CHtml::link('<i class="fa fa-edit"></i>', array('suraktifcuti/updatenosuraktifcutioperator','id'=>$this->IDAKTIFCUTI), array('class' => 'btn btn-sm green'));
                } 
        }

...
class Surtugpm extends CActiveRecord
{
	...
	public function search()
	{
       ...
       if ($b > 0) {
            echo CHtml::link('<i data-feather="printer"></i>',array('cetak/surtugpm','id'=>$this->IDPM),array('target'=>'_blank','class'=>'btn btn-gradient-warning'));
       ...
       if ($b > 0) {
            echo CHtml::link('<i data-feather="printer"></i>',array('cetak/surtugpenyusunanpm','id'=>$this->IDPM),array('target'=>'_blank','class'=>'btn btn-gradient-warning'));

	...
	public function search()
	{
        ...
        public function getListactionnotifikasi(){
            ...
            if ($b == 'Y') {
                ...
                echo CHtml::link('<i class="fa fa-search"></i>', array('detailsurijincuti/view', 'id' => $this->IDDETAILSURIJINCUTI), array('class' => 'btn btn-sm blue')),'&nbsp';
                echo CHtml::link('<i class="fa fa-edit"></i>', array('surijincuti/updatenosurijincuti','id'=>$this->IDIJINCUTI), array('class' => 'btn btn-sm green'));
               
            } else {
               
                if ($c == 'N') {
                   
                    echo CHtml::link('<i class="fa fa-search"></i>', array('detailsurijincuti/view', 'id' => $this->IDDETAILSURIJINCUTI), array('class' => 'btn btn-sm red')),'&nbsp';
                    echo CHtml::link('<i class="fa fa-edit"></i>', array('surijincuti/updatenosurijincuti','id'=>$this->IDIJINCUTI), array('class' => 'btn btn-sm green'));
                } 
        }

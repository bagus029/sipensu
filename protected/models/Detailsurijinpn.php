	...
	public function search()
	{
        ...
        public function getListactionnotifikasi(){
            ...
            if ($b == 'Y') {
                ...
                echo CHtml::link('<i data-feather="search"></i>', array('detailsurijinpn/view', 'id' => $this->IDDETAILSURIJINPN), array('class' => 'btn btn-info')),'&nbsp';
                echo CHtml::link('<i data-feather="edit"></i>', array('surijinpn/updatenosurijinpnoperator','id'=>$this->IDIJINPN), array('class' => 'btn btn-success'));
               
            } else {
               
                if ($c == 'N') {
                   
                    echo CHtml::link('<i data-feather="search"></i>', array('detailsurijinpn/view', 'id' => $this->IDDETAILSURIJINPN), array('class' => 'btn btn-danger')),'&nbsp';
                    echo CHtml::link('<i data-feather="edit"></i>', array('surijinpn/updatenosurijinpnoperator','id'=>$this->IDIJINPN), array('class' => 'btn btn-primary'));
                } 
        }

    ...
    //membuat tombol action notifikasi
        public function getListactionnotifikasi(){
            ...
            if ($b == 'Y') {
                ...
                echo CHtml::link('<i data-feather="search"></i>', array('detailsuratketerangan/view', 'id' => $this->IDDETAILSURKET), array('class' => 'btn btn-info')),'&nbsp';
                echo CHtml::link('<i data-feather="edit"></i>', array('suratketerangan/updatenosuratketeranganoperator','id'=>$this->IDSURKET), array('class' => 'btn btn-danger'));
               
            } else {
               
                if ($c == 'N') {
                   
                    echo CHtml::link('<i data-feather="search"></i>', array('detailsuratketerangan/view', 'id' => $this->IDDETAILSURKET), array('class' => 'btn btn-success')),'&nbsp';
                    echo CHtml::link('<i data-feather="edit"></i>', array('suratketerangan/updatenosuratketeranganoperator','id'=>$this->IDSURKET), array('class' => 'btn btn-primary'));
                } 
        }

...
class Surisu extends CActiveRecord
{
    ...
    public function getCetakbytgl()
    {
        ...
        if ($b > 0) {
            echo CHtml::link('<i data-feather="printer"></i> QR', array('cetak/surisu', 'id' => $this->IDISU,'tipe'=>'1'), array('target' => '_blank', 'class' => 'btn btn-gradient-primary'));
            echo CHtml::link('<i data-feather="printer"></i> No QR', array('cetak/surisu', 'id' => $this->IDISU,'tipe'=>'2'), array('target' => '_blank', 'class' => 'btn btn-gradient-danger'));

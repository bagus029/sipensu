	...
	public function search()
	{
        ...
        public function getListactionnotifikasi(){
            ...
            if ($b == 'Y') {
                ...
                echo CHtml::link('<i data-feather="search"></i>', array('detailsurmag/view', 'id' => $this->IDDETAILSURMAG), array('class' => 'btn btn-info')),'&nbsp';
                echo CHtml::link('<i data-feather="edit"></i>', array('surmag/updatenosurmagoperator','id'=>$this->IDSURMAG), array('class' => 'btn btn-success'));
               
            } else {
               
                if ($c == 'N') {
                   
                    echo CHtml::link('<i data-feather="search"></i>', array('detailsurmag/view', 'id' => $this->IDDETAILSURMAG), array('class' => 'btn btn-warning')),'&nbsp';
                    echo CHtml::link('<i data-feather="edit"></i>', array('surmag/updatenosurmagoperator','id'=>$this->IDSURMAG), array('class' => 'btn btn-primary'));
                } 
        }

	...
	public function search()
	{
        ...
        public function getListactionnotifikasi(){
            ...
            if ($b == 'Y') {
                ...
                echo CHtml::link('<i data-feather="search"></i>', array('detailsurpelpk/view', 'id' => $this->IDDETAILSURPELPK), array('class' => 'btn btn-info')),'&nbsp';
                echo CHtml::link('<i data-feather="edit"></i>', array('subdetailsurpelpk/updatenosurpelpkoperator','id'=>$this->IDSUBDETAILSURPELPK), array('class' => 'btn btn-success'));
               
            } else {
               
                if ($c == 'N') {
                   
                    echo CHtml::link('<i data-feather="search"></i>', array('detailsurpelpk/view', 'id' => $this->IDDETAILSURPELPK), array('class' => 'btn btn-danger')),'&nbsp';
                    echo CHtml::link('<i data-feather="edit"></i>', array('subdetailsurpelpk/updatenosurpelpkoperator','id'=>$this->IDSUBDETAILSURPELPK), array('class' => 'btn btn-primary'));
                } 
        }

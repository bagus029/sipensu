...
class Surperpk extends CActiveRecord
{
	...
	public function search()
	{
       ...
       if ($b > 0) {
            echo CHtml::link('<i data-feather="printer"></i> QR',array('cetak/surperpk','id'=>$this->IDPK, 'tipe'=>'1'),array('target'=>'_blank','class'=>'btn btn-gradient-primary'));
           echo CHtml::link('<i data-feather="printer"></i> No QR',array('cetak/surperpk','id'=>$this->IDPK, 'tipe'=>'2'),array('target'=>'_blank','class'=>'btn btn-gradient-danger'));

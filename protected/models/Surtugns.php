...
return parent::beforeSave();
   ...
   public function getListsendsuratns(){
    ...
    if ($b > 0) {
        echo CHtml::link('<i data-feather="printer"></i> QR', array('cetak/surtugns', 'id' => $this->IDSURTUGNS,'tipe'=>'1'), array('target' => '_blank', 'class' => 'btn btn-gradient-primary'));
        echo CHtml::link('<i data-feather="printer"></i>No QR', array('cetak/surtugns', 'id' => $this->IDSURTUGNS,'tipe'=>'2'), array('target' => '_blank', 'class' => 'btn btn-gradient-danger'));

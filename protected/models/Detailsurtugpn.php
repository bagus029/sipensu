       ...
       //membuat tombol action notifikasi
        public function getListactionnotifikasi(){
            ...
            if ($b == 'Y') {
                ...
                echo CHtml::link('<i data-feather="search"></i>', array('detailsurtugpn/view', 'id' => $this->IDDETAILSURTUGPN), array('class' => 'btn btn-info')),'&nbsp';
                echo CHtml::link('<i data-feather="edit"></i>', array('surtugpn/updatenosurtugpnoperator','id'=>$this->IDPN), array('class' => 'btn btn-success'));
               
            } else {
               
                if ($c == 'N') {
                   
                    echo CHtml::link('<i data-feather="search"></i>', array('detailsurtugpn/view', 'id' => $this->IDDETAILSURTUGPN), array('class' => 'btn btn-danger')),'&nbsp';
                    echo CHtml::link('<i data-feather="edit"></i>', array('surtugpn/updatenosurtugpnoperator','id'=>$this->IDPN), array('class' => 'btn btn-dark'));
                } 
        }

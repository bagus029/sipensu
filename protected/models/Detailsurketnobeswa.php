	...
	public function search()
	{
        ...
        public function getListactionnotifikasi(){
            ...
            if ($b == 'Y') {
                ...
                echo CHtml::link('<i data-feather="search"></i>', array('detailsurketnobeswa/view', 'id' => $this->IDDETAILSURKETNOBESWA), array('class' => 'btn btn-info')),'&nbsp';
                echo CHtml::link('<i data-feather="edit"></i>', array('surketnobeswa/updatenosurketnobeswaoperator','id'=>$this->IDSURKETNOBESWA), array('class' => 'btn btn-success'));
               
            } else {
               
                if ($c == 'N') {
                   
                    echo CHtml::link('<i data-feather="search"></i>', array('detailsurketnobeswa/view', 'id' => $this->IDDETAILSURKETNOBESWA), array('class' => 'btn btn-danger')),'&nbsp';
                    echo CHtml::link('<i data-feather="edit"></i>', array('surketnobeswa/updatenosurketnobeswaoperator','id'=>$this->IDSURKETNOBESWA), array('class' => 'btn btn-primary'));
                } 
        }

...
class Detailsurtugpm extends CActiveRecord
{
    ...
    public function getListactionnotifikasi(){
        ...
        if ($b == 'Y') {
            ...
            echo CHtml::link('<i data-feather="search"></i>', array('detailsurtugpm/view', 'id' => $this->IDDETAILSURTUGPM), array('class' => 'btn btn-info')),'&nbsp';
            echo CHtml::link('<i data-feather="edit"></i>', array('surtugpm/updatenosurtugpmoperator','id'=>$this->IDPM), array('class' => 'btn btn-warning'));

        } else {

            if ($c == 'N') {

                echo CHtml::link('<i data-feather="search"></i>', array('detailsurtugpm/view', 'id' => $this->IDDETAILSURTUGPM), array('class' => 'btn btn-danger')),'&nbsp';
                echo CHtml::link('<i data-feather="edit"></i>', array('surtugpm/updatenosurtugpmoperator','id'=>$this->IDPM), array('class' => 'btn btn-primary'));
            }
        }

...
class Surtugmonitoring extends CActiveRecord
{
    ...
    public function getAccdekanat()
    {
     ...
     public function getCetakbytgl(){
       ...
       if ($b > 0) {
            echo CHtml::link('<i class="fa fa-print"></i> Cetak',array('cetak/surtugmonitoring','id'=>$this->IDSURTUGMONITORING,'tipe'=>'1'),array('target'=>'_blank','class'=>'btn btn-gradient-primary'));
           echo CHtml::link('<i class="fa fa-print"></i> Cetak',array('cetak/surtugmonitoring','id'=>$this->IDSURTUGMONITORING,'tipe'=>'2'),array('target'=>'_blank','class'=>'btn btn-gradient-danger'));

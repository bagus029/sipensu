...
class JabatanstrukturalController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Jabatanstruktural']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->IDJABATANSTRUKTURAL));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Jabatanstruktural');
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='jabatanstruktural-form')
		{

...
class SurpermkController extends Controller {
    ...
    public function accessRules() {
        return array(
            ...
            array('allow', // allow authenticated user to perform 'create' and 'update' actions
                'actions' => array('create', 'createbymahasiswa', 'update', 'deletebyowner', 'updatebymahasiswa', 'admin', 'view',
                    'updatenosurpermk', 'updatenosurpermkoperator', 'permintaansurat', 'isisurat', 'AjaxTtd', 'notifikasi', 'preview'
                ,'AjaxDekanat','dekanat','subkor'),
                'users' => array('@'),
            ),
            array('allow', // allow admin user to perform 'admin' and 'delete' actions
                'actions' => array('admin', 'delete', 'create', 'createbymahasiswa', 'deletebyowner', 'update'
                , 'updatebymahasiswa', 'admin', 'view', 'updatenosurpermk', 'AjaxTtd', 'Ajaxsubkor', 'Ajaxdekanat','notifikasi', 'preview'),
                'users' => array('admin'),
            ),
    ...
    public function actionNotifikasi() {
        ...
        $sql = "select count(IDMK) as newrecord from surpermk where PREVIEW='N' ";
    ...
    public function actionPreview() {
        ...
        $sql = "select * from surpermk WHERE IDGROUPS='$user'";
        $data = Yii::app()->db->createCommand($sql)->queryAll();
    ...
    public function actionAjaxTtd() {
        ...
        $model->TANGGALACCSURPERMK = date('Y-m-d H:i:s');
        if ($model->update()) {
    ...
    public function actionAdmin() {
        ...
        /*$model->dbCriteria->condition = 'ACCSUBKOR=:ACCSUBKOR';
        $model->dbCriteria->params = array(':ACCSUBKOR' => $ACCSUBKOR);

        $model->dbCriteria->condition = 'ACCDEKANAT=:ACCDEKANAT';
        $model->dbCriteria->params = array(':ACCDEKANAT' => $ACCDEKANAT);*/
        if (isset($_GET['Surpermk']))
            $model->attributes = $_GET['Surpermk'];

...
class SurijinpnController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','view','admin','permintaansurat','isisurat','updatenosurijinpn','deletebyowner',
                    'updatenosurijinpnoperator','createbymahasiswa','updatebymahasiswa','AjaxTtd','notifikasi','preview','AjaxDekanat','dekanat','subkor'),
				'users'=>array('@'),
			),
	 ...
	 */
        ...
        $sql = "select count(IDIJINPN) as newrecord from surijinpn where PREVIEW='N' ";
    ...
    public function actionPreview() {
        ...
        $sql="select * from surijinpn WHERE IDGROUPS='$user'";
        $data = Yii::app()->db->createCommand($sql)->queryAll();
        ...
        public function actionAjaxTtd(){
                        ...
                        $model->TANGGALACCSURIJINPN = date('Y-m-d H:i:s');

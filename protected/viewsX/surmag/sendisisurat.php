...
<div class="actions">
       ...
       echo CHtml::link('Ajukan permintaan/permohonan surat.... &nbsp<i class="fa fa-arrow-circle-right"></i>',array('detailsurmag/createbymahasiswa','IDSURMAG'=>$model->IDSURMAG),array('class'=>'btn btn-default purple'));

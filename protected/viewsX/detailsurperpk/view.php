...
<div class="portlet-title">
  <div class="caption">
	<i class="fa fa-pencil-square-o"></i> View Acc. Surat Permohonan Praktik Kerja (Prodi D3) #<?php echo $model->IDDETAILSURPERPK; ?>  </div>
</div>
...
<?php
echo CHtml::link('Manage ',array('detailsurperpk/admin'),array('class'=>'btn btn-sm blue'));
?>
</div>
</div>
</div>

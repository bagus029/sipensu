...
<div class="portlet-title">
  <div class="caption">
	<i class="fa fa-pencil-square-o"></i> View Permintaan Surat Izin Cuti Akademik  #<?php echo $model->IDIJINCUTI; ?>  
  </div>
</div>
...
<div class="caption">
	<i class="fa fa-envelope"></i> Kirim Permintaan Surat Izin Cuti Akademik #<?php echo $model->IDIJINCUTI; ?>  </div>
        ...
        if($b==0){    
        echo CHtml::link('Ajukan permintaan/permohonan surat.... <i class="fa fa-arrow-circle-right"></i>',array('detailsurijincuti/create','IDIJINCUTI'=>$model->IDIJINCUTI),array('class'=>'btn btn purple'));
         }
        else
        {
...
<?php
$IDIJINCUTI = Yii::app()->request->getParam('id', 0);
$smod4el = Surijincuti::model()->updateByPk
        ($IDIJINCUTI, array("PREVIEW" => 'Y'));
?>

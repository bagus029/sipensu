...
$('.search-form form').submit(function(){
	$('#surisu-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	//	'ALAMATINSTANSIISU',
        ...
        /*array(
                    'header'=>'Isi Surat',
                    'type'=>'raw',
                    'value'=>'CHtml::link("View ",array("surisu/isisurat","id"=>$data->primaryKey),array ("target"=>"_blank","class"=>"btn btn-sm purple "))',
...
<font color="red"><i class="fa fa-check"></i></font><font color="white">&nbsp;Status surat sudah jadi/dapat diambil</font><br>
<font color="red"><i class="icon-question"></i></font><font color="white">&nbsp;Status surat sedang dalam proses</font><br>
<font color="red"><i class="fa fa-times"></i></font><font color="white">&nbsp;Status surat tidak jadi/terjadi kesalahan/syarat kurang</font>

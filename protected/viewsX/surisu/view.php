...
?>
    <?php 
       ...
       echo CHtml::link('Tambah Mahasiswa &nbsp<i class="fa fa-user"></i>',array('groupsurisu/create','IDISU'=>$model->IDISU),array('class'=>'btn btn-default blue'));
...
<div class="actions">
       ...
       echo CHtml::link('Ajukan permintaan/permohonan surat.... &nbsp<i class="fa fa-arrow-circle-right"></i>',array('detailsurisu/create','IDISU'=>$model->IDISU),array('class'=>'btn btn purple'));

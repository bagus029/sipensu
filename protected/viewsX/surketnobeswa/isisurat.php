...
<?php $this->widget('zii.widgets.CDetailView', array(
 ...
 <div class="form-actions  left">
     <div class="">
		 ...
		 <?php echo CHtml::link('Lihat Daftar Permintaan Surat  <i class="fa fa-search"></i>' ,array('surketnobeswa/permintaansurat'),array('class'=>'btn green'));?> 
                 <?php 
                    ...
                    if($b==0){    
                    echo CHtml::link('Edit  <i class="fa fa-edit"></i>',array('surketnobeswa/updatebymahasiswa','id'=>$model->IDSURKETNOBESWA),array('class'=>'btn blue ')); 
                   
                    echo CHtml::link('Update Biodata  <i class="fa fa-edit"></i>',array('mahasiswa/updatebiodatamhs','nim'=>$model->NIM,'id'=>$model->IDSURKETNOBESWA),array('class'=>'btn dark '));
                    } 
                    else {
                       echo "";
                     }
...
<div class="caption">
	<i class="fa fa-envelope"></i> Kirim Permintaan Surat Keterangan Tidak Menerima Beasiswa #<?php echo $model->IDSURKETNOBESWA; ?>  </div>
        ...
        if($b==0){    
        echo CHtml::link('Ajukan permintaan/permohonan surat.... <i class="fa fa-arrow-circle-right"></i>',array('detailsurketnobeswa/createbymahasiswa','IDSURKETNOBESWA'=>$model->IDSURKETNOBESWA),array('class'=>'btn btn purple'));
         }
        else
        {

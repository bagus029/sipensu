...
<div class="form-actions  left">
     <div class="">
		 ...
		 <?php echo CHtml::link('Lihat Daftar Permintaan Surat  <i class="fa fa-search"></i>' ,array('surijinpn/permintaansurat'),array('class'=>'btn green'));?> 
                 <?php 
                    $a=$model->IDIJINPN;
                    ...
                    if($b==0){    
                    echo CHtml::link('Edit  <i class="fa fa-edit"></i>',array('surijinpn/updatebymahasiswa','id'=>$model->IDIJINPN),array('class'=>'btn blue '));
                    }
                    else
                    {
                       echo "";
...
<div class="caption">
	<i class="fa fa-envelope"></i> Kirim Permintaan Surat Ijin Penelitian #<?php echo $model->IDIJINPN; ?>  </div>
        ...
        if($b==0){    
        echo CHtml::link('Ajukan permintaan/permohonan surat.... <i class="fa fa-arrow-circle-right"></i>',array('detailsurijinpn/createbymahasiswa','IDIJINPN'=>$model->IDIJINPN),array('class'=>'btn btn purple'));
         }
        else
        {
